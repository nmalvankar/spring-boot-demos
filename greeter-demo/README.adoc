...
== Running the Example Application on a standalone JBoss Web Server(JWS) 5 (Tomcat 9) instance
If you have a standalone JWS 5 instance, you can also deploy your example there
----
$ mvn clean package

$ cp target/greeter-tomcat-demo-1.0.0.war $JWS5.3_HOME/tomcat/webapps/

$ $JWS5.3_HOME/bin/startup.sh
----
